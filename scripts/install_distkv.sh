...
SERVER_JAR=$SCRIPT_DIR/../server/target/distkv-server-0.1.2-SNAPSHOT-jar-with-dependencies.jar
CLIENT_JAR=$SCRIPT_DIR/../client/target/distkv-client-0.1.2-SNAPSHOT-jar-with-dependencies.jar
...
sudo cp $SERVER_JAR $SERVER_INSTALLING_DEST/distkv-server-0.1.2-SNAPSHOT-jar-with-dependencies.jar
sudo chown dkv:dkv $SERVER_INSTALLING_DEST/distkv-server-0.1.2-SNAPSHOT-jar-with-dependencies.jar

sudo cp $CLIENT_JAR $CLIENT_INSTALLING_DEST/distkv-client-0.1.2-SNAPSHOT-jar-with-dependencies.jar
sudo chown dkv:dkv $CLIENT_INSTALLING_DEST/distkv-client-0.1.2-SNAPSHOT-jar-with-dependencies.jar
